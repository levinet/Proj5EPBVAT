...
public class CommissionCalculator implements iCommissionCalculator {
	...
	public double calculateCommission() {
		final double commissionRatesForProbationaryEmployee[] = { 0.02, 0.03,
				0.01, 0.03 }; 
		//AMP: final double commissionRatesForProbationaryEmployee[] = { 2, 3,
		//1, 3 };
		//AMP: These values will give commission rates of 200%, 300%, 100%, 300%
		//AMP: Must convert to decimal version 
	...
	//AMP No getter for employee experience. Implemented here.
